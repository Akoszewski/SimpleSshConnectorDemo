...
class TerminalForegroundService : Service() {
    ...
    companion object {
        private const val ACTION_START = "com.example.simplesshconnector.action.START_TERMINAL_FOREGROUND"
        private const val ACTION_STOP = "com.example.simplesshconnector.action.STOP_TERMINAL_FOREGROUND"
